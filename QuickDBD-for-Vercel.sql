...
ALTER TABLE Projects ADD CONSTRAINT fk_Project_UserID FOREIGN KEY(UserID)
REFERENCES Users (UserID);

ALTER TABLE Tasks ADD CONSTRAINT fk_Task_ProjectID FOREIGN KEY(ProjectID)
REFERENCES Projects (ProjectID);

ALTER TABLE Tasks ADD CONSTRAINT fk_Task_CategoryID FOREIGN KEY(CategoryID)
REFERENCES Categories (CategoryID);

ALTER TABLE TaskAssociates ADD CONSTRAINT fk_TaskAssociate_TaskID FOREIGN KEY(TaskID)
REFERENCES Tasks (TaskID);

ALTER TABLE TaskAssociates ADD CONSTRAINT fk_TaskAssociate_AssociateID FOREIGN KEY(AssociateID)
